 ...
 */
public class BSDialog extends AppCompatDialog {

    public BSDialog(@NonNull Context context) {
        this(context, 0);
    }

    public BSDialog(@NonNull Context context, @StyleRes int theme) {
        super(context, getThemeResId(context, theme));
    }

    protected BSDialog(@NonNull Context context, boolean cancelable,
